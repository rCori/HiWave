...
void AHiWavePawn::FireShotChild()
{
}
...
void AHiWavePawn::ChangeBulletLevel(const int &newBulletLevel)
{
	...
	//multiplier decay rate is tracked differently because it can be stopped and started in a way that currentGunOffset is not.
